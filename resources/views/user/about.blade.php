    ...
    <section class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div class="rounded-[2rem] border border-brand-border bg-white p-6 shadow-sm sm:p-8">
            ...
            <h1 class="mt-2 font-display text-4xl font-semibold text-brand-primary">
                {{ $aboutSection->heading ?? 'A small studio with a handmade focus' }}
            </h1>
            <p class="mt-4 leading-7 text-brand-ink/70">
                {!! nl2br(e($aboutSection->content ?? 'Crafted Pieces creates crochet gifts, accessories, and custom pieces with a careful process and consistent quality.')) !!}
            </p>
