...
@php
    ...
    $maps = [
        'order' => [
            ...
            'pending_payment' => ['label' => 'Pending Payment', 'classes' => 'bg-amber-100 text-amber-800 ring-1 ring-amber-200'],
            'processing' => ['label' => 'Processing', 'classes' => 'bg-sky-100 text-sky-800 ring-1 ring-sky-200'],
            'preparing' => ['label' => 'Preparing', 'classes' => 'bg-sky-100 text-sky-800 ring-1 ring-sky-200'],
            'ready_for_pickup' => ['label' => 'Ready for Pickup', 'classes' => 'bg-cyan-100 text-cyan-800 ring-1 ring-cyan-200'],
        ...
        'quote' => [
            'pending' => ['label' => 'Pending', 'classes' => 'bg-stone-100 text-stone-700 ring-1 ring-stone-200'],
            'quoted' => ['label' => 'Price Quoted', 'classes' => 'bg-pink-100 text-pink-800 ring-1 ring-pink-200'],
            'accepted' => ['label' => 'Quote Accepted', 'classes' => 'bg-emerald-100 text-emerald-800 ring-1 ring-emerald-200'],
            'declined' => ['label' => 'Quote Declined', 'classes' => 'bg-rose-100 text-rose-800 ring-1 ring-rose-200'],
        ],
        'generic' => [],
    ];
