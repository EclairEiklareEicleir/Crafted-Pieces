...
<div class="group flex h-full min-h-[27rem] flex-col overflow-hidden rounded-[1.75rem] border border-brand-border bg-white/85 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
