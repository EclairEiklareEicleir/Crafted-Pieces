...
@if ($product->stock > 0)
    <div id="{{ $modalId }}"
        ...
        @else
            <div class="relative z-10 w-full max-w-lg overflow-hidden rounded-[1.75rem] border border-brand-border bg-white shadow-2xl shadow-brand-primary/15">
                <div class="flex items-start justify-between gap-4 border-b border-brand-border bg-brand-surface px-5 py-4">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.18em] text-brand-secondary">
                            Add to cart
                ...
                <div class="grid gap-5 p-5 sm:grid-cols-[9rem_minmax(0,1fr)]">
                    ...
                    <div class="min-w-0 space-y-4">
                        <p class="text-sm leading-6 text-brand-ink/70">
                            Log in to choose yarn colors and add this product to your cart.
                        </p>

                        <button type="button" data-auth-modal-open class="brand-btn-primary w-full py-3 text-sm">
